...
try {
  // Get the base URL from environment - prioritize production domain for EPX
  const baseUrl = process.env.EPX_REDIRECT_URL 
    ? new URL(process.env.EPX_REDIRECT_URL).origin  // Extract domain from redirect URL
