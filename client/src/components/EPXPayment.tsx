...
export function EPXPayment({
  ...
  const handleBrowserPostPayment = async () => {
    ...
    try {
      ...
      console.log(
        "[EPX Payment] Creating form for submission to:",
        data.formData.actionUrl,
      );
      ...
      const fields: any = {
        ...
        AMOUNT: data.formData.AMOUNT.toFixed
          ? data.formData.AMOUNT.toFixed(2)
      ...
      setTimeout(() => {
        console.log(
          "[EPX Payment] Form submission initiated - redirecting to EPX payment page",
        );
        form.submit();
      }, 100);
    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent className="space-y-4">
          ...
          <div className="space-y-3 mb-4 p-4 bg-gray-50 rounded-lg">
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setAchData({ ...achData, accountName: e.target.value })
                }
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value: "checking" | "savings") =>
                  setAchData({ ...achData, accountType: value })
                }
              >
            ...
            <Alert className="mt-3">
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                By providing your bank account information, you authorize us to
                debit your account for the subscription amount.
              </AlertDescription>
            </Alert>
          </div>
        )}
        ...
        <div className="text-xs text-center text-muted-foreground">
          ...
          <p className="mt-1">
            Secure Browser Post Payment • Powered by North.com EPx
          </p>
        </div>
      </CardContent>
    </Card>
