...
export default function AdminEnrollments() {
  ...
  const getPaymentStatusBadge = (paymentStatus?: string | null, transactionId?: string | null) => {
    ...
    switch (paymentStatus.toLowerCase()) {
      ...
      case "failed":
      case "declined":
        return <Badge className="bg-red-100 text-red-800">G�� Failed</Badge>;
      case "pending":
        return <Badge className="bg-yellow-100 text-yellow-800">GŦ Pending</Badge>;
      case "refunded":
        return <Badge className="bg-purple-100 text-purple-800">G� Refunded</Badge>;
      default:
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            {!showMembershipOversight ? (
              <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50 p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
