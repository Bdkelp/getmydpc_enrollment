  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <AlertDialog open={confirmLiveRecurringOpen} onOpenChange={(open) => {
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will process all currently due recurring payments and then update commissions for successful payments only. Failed or skipped payments will not create commission entries. Continue?
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel disabled={recurringWorkflowMutation.isPending}>
                Cancel
              </AlertDialogCancel>
              <AlertDialogAction
